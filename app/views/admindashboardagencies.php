...
// $sql = "SELECT id, name, adresse_id,bank_id FROM agency";
...
//     // Retrieve form data
//     $name = $_POST["name"];
//     $adresse = $_POST["adresse_id"];
//     $bank = $_POST["bank_id"];
    

//     // Use prepared statement to prevent SQL injection
//     $sql = "INSERT INTO user (nom, adresse_id,bank_id) VALUES (?, ?,?)";
//     $stmt = $conn->prepare($sql);
//     $stmt->bind_param("sss", $name, $adresse,$bank);
...
// if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_agencie_id'])) {
//     if (isset($_POST['delete_agencie_id'])) {
//         $deleteUserId = $_POST['delete_agencie_id'];

//         // Use prepared statement to delete the user and associated accounts
//         $sql = "DELETE FROM agency WHERE id = ?";
//         $stmt = $conn->prepare($sql);
                    ...
                    <table class="w-full">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4  py-3">adresse_id</th>
                                
                                <th scope="col" class="px-4  py-3">bank_id</th>
                            ...
                            <?php foreach ($rows as $row): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex justify-center items-center">
                                        ...
                                        <form method="post">
                                            <input type="hidden" name="delete_agence_id" value="<?= $row['id'] ?>">
                                            <button type="submit"
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <div
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add agency</h3>
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <label for="adresse_id"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">adress_id</label>
                                        <input type="text" name="adresse_id" id="adresse_id"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client adresse_id" required="">
                                    </div>
                                    <div>
                                        <label for="bank_id"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">bank_id</label>
                                        <input type="text" name="bank_id" id="bank_id"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client bank_id" required="">
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex justify-center items-center space-x-4">
                                        <button data-modal-toggle="deleteModal" type="button"
                                            ...
                                            cancel</button>
                                        <button type="submit" name="delete_agencie_id"
