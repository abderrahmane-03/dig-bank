...
// $sql = "SELECT id, username, password, adresse_id, agency_id, role_id FROM user";
...
//     $sql = "INSERT INTO user (username, password, adresse_id, agency_id, role_id) VALUES (?, ?, ?, ?, ?)";
...
//     // Retrieve form data
//     $editUserId = $_POST['edit_user_submit'];
//     $newUsername = isset($_POST["new_username"]) ? $_POST["new_username"] : '';
//     $newPassword = isset($_POST["new_password"]) ? $_POST["new_password"] : '';
//     $newAdresse = isset($_POST["new_adresse"]) ? $_POST["new_adresse"] : '';
//     $newAgence = isset($_POST["new_agence"]) ? $_POST["new_agence"] : '';
//     $newRole = isset($_POST["new_role"]) ? $_POST["new_role"] : '';

//     // Use prepared statement to update the user information
//     $sql = "UPDATE user SET username=?, password=?, adresse_id=?, agency_id=?, role_id=? WHERE id=?";
//     $stmt = $conn->prepare($sql);
//     $stmt->bind_param("sssssi", $newUsername, $newPassword, $newAdresse, $newAgence, $newRole, $editUserId);
//     // Execute the statement
//     $result = $stmt->execute();
    ...
    <section class="ml-64 bg-gray-50 p-3 sm:p-5 antialiased">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex justify-center items-center">
                                        ...
                                        <form method="post">
                                            ...
                                            <button type="button" onclick="showUpdateClientModal()"
                                                class="flex w-full items-center py-2 px-2 hover:bg-gray-100 rounded-lg dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                <svg class="w-4 h-4 text-gray-800 dark:text-white"
                                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                    viewBox="0 0 20 18">
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="adresse" id="adresse"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client adresse" required="">
                                    </div>
                                    <div>
                                        <label for="agence"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">agence</label>
                                        <input type="text" name="agence" id="agence"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client agence" required="">
                                    </div>
                                    <div>
                                        <label for="role"
                                        ...
                                        <input type="text" name="role" id="role"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="1 for admin 2 for client" required="">
                                    </div>
                ...
                <!-- Update modal -->
                <div id="updateclientModal" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <div
                                ...
                                <button type="button" onclick="hideUpdateClientModal()"
                                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                    data-modal-toggle="updateclientModal">
                                    <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <input type="text" name="new_username" id="new_username"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="Type client new_username" required="">
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" name="new_password" id="new_password"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client new_password" required="">
                                    </div>
                                    <div>
                                        <label for="new_adresse"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">adresse</label>
                                        <input type="text" name="new_adresse" id="new_adresse"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client new_adresse" required="">
                                    </div>
                                    <div>
                                        <label for="new_agence"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">agence</label>
                                        <input type="text" name="new_agence" id="new_agence"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client new_agence" required="">
                                    </div>
                                    <div>
                                        <label for="new_role"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">role</label>
                                        <input type="text" name="new_role" id="new_role"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="1 for admin 2 for " required="">
                                    </div>
                                    <button type="submit" name="edit_user_submit" onclick="hideUpdateClientModal()"
                                        class="text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                        <svg class="mr-1 -ml-1 w-6 h-6" fill="currentColor" viewbox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                                ...
                                <div
                                    ...
                                    <div class="flex justify-center items-center space-x-4">
                                        <button data-modal-toggle="deleteModal" type="button"
                                            ...
                                            cancel</button>
                                        <button type="submit" name="delete_user_id"
