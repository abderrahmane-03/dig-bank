...
// $sql = "SELECT id, adresse_id FROM atm";
...
//     $sql = "INSERT INTO atm (adresse_id) VALUES (?)";
//     $stmt = $conn->prepare($sql);
//     $stmt->bind_param("i", $adresse);
...
// if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_atm_id'])) {
//     if (isset($_POST['delete_atm_id'])) {
//         $deleteUserId = $_POST['delete_atm_id'];

//         // Use prepared statement to delete the user and associated accounts
//         $sql = "DELETE FROM atm WHERE id = ?";
//         $stmt = $conn->prepare($sql);
                            ...
                            <?php foreach ($rows as $row): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex justify-center items-center">
                                        ...
                                        <form method="post">
                                            <input type="hidden" name="delete_atm_id" value="<?= $row['id'] ?>">
                                            <button type="submit"
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <div
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add atm</h3>
                                ...
                                <div
                                    ...
                                    <div class="flex justify-center items-center space-x-4">
                                        <button data-modal-toggle="deleteModal" type="button"
                                            ...
                                            cancel</button>
                                        <button type="submit" name="delete_atm_id"
